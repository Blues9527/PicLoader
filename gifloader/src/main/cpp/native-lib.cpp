...
Java_com_blues_gifloader_PicHandler_openFileNative(JNIEnv *env, jobject instance, jstring path_) {
...
Java_com_blues_gifloader_PicHandler_getWidthNative(JNIEnv *env, jobject thiz, jlong gif_info) {
    //获取宽
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_blues_gifloader_PicHandler_getHeightNative(JNIEnv *env, jobject thiz, jlong gif_info) {
    //获取高
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_blues_gifloader_PicHandler_getLengthNative(JNIEnv *env, jobject thiz, jlong gif_info) {
    //获取图片帧数
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_blues_gifloader_PicHandler_renderFrameNative(JNIEnv *env, jobject thiz, jlong gif_info,
